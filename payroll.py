...
cnx=create_engine('mysql+pymysql://root:@localhost/payroll')
#con = engine.connect() 
...
def Salary_show(): 
    subprocess.call('C:/Program Files/Microsoft Office/root/Office16/excel c:/payroll/salary.csv') 
...
while (True): 
    ...
    print("4 : SHOW CURRENT DA AND HFRA RATES") 
